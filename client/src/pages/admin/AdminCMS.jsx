...
export const AdminFAQs = () => {
  ...
  const mockFAQs = [
    ...
    { _id: '3', question: 'What is your consultation process?', answer: "We start with a free consultation to understand your space, your needs, and how you actually want to live in it. From there, we move into detailed design and planning, so nothing gets built until the vision is fully worked out.", category: 'process', order: 3 },
