...
export const AdminFAQs = () => {
  ...
  const mockFAQs = [
    { _id: '1', question: 'How long does a project usually take?', answer: "Most projects take about two to three months from start to finish. The exact timeline depends on how detailed and customized your space is, but we'll give you a clear schedule before work begins so there are no surprises along the way.", category: 'timeline', order: 1 },
    { _id: '2', question: 'Do you provide turnkey interior solutions?', answer: "Yes. Every project we take on, whether it's a home or a commercial space, is handled fully by our own team. Design, materials, execution, and final finishing all happen under one roof, so you're never left coordinating between different vendors.", category: 'services', order: 2 },
    { _id: '3', question: 'What is your consultation process?', answer: "We start with a consultation to understand your space, your needs, and how you actually want to live in it. From there, we move into detailed design and planning, so nothing gets built until the vision is fully worked out.", category: 'process', order: 3 },
    { _id: '4', question: 'Which locations do you currently serve?', answer: "We're based in Hyderabad and have delivered homes and commercial spaces across the city.", category: 'general', order: 4 },
    { _id: '5', question: 'How can customers request a quotation?', answer: "Just fill out the contact form on our website, and our team will personally reach out to understand your project and walk you through next steps.", category: 'pricing', order: 5 },
    { _id: '6', question: 'Do you sell materials separately from design services?', answer: "Yes. Materials like WPC panels, polygranite sheets, and acrylic sheets are available for standalone purchase, even if you're not booking a full design or execution project with us.", category: 'materials', order: 6 },
    { _id: '7', question: 'What if I already have a design in mind, can you just execute it?', answer: "Of course. Whether you already have a finalized design or need us to build one from scratch, we can step in wherever you need us, whether that's execution only or a complete design and build package.", category: 'services', order: 7 },
    { _id: '8', question: 'Can I customize designs, or do you offer fixed packages?', answer: "Every project is designed around your space and your preferences. We don't work off fixed templates or one size fits all packages, so what you get is built specifically for you.", category: 'process', order: 8 },
    { _id: '9', question: 'Do you provide warranties on completed projects?', answer: "Yes. We offer up to ten year comprehensive warranties on hardware and core modular components, backed directly by factory certification.", category: 'general', order: 9 },
    { _id: '10', question: 'What does the design and execution process actually look like?', answer: "We start with a design consultation to understand your space and what you're looking for. Once the overall theme is locked in, we move into 3D visualizations so you can see exactly how the space will look before anything is built. After the designs are finalized, our team takes over execution, keeping you updated along the way until final handover.", category: 'process', order: 10 }
  ];
